        ...
        selectOptions: [
          {
            ...
            selectTableCells: [
              '101 - 176',
              'Verfassung - Kantonsgebiet - Gemeinden - Bürgerrecht - Politische Rechte - Behörden',
            ],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '2',
            label: '2',
            selectTableCells: ['177 - 184', 'Staatspersonal - Kirchen - Religionsgemeinschaften'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '3',
            ...
            selectTableCells: [
              '211 - 255',
              'Gerichtsorganisation - Zivilrecht - Notariat - Grundbuch',
            ],
            id: _.uniqueId('fileNumber'),
          },
          {
            ...
            selectTableCells: [
              '281 - 351',
              'Schuldbetreibung und Konkurs - Strafrecht - Strafvollzug - Opferhilfe - Gewaltschutz',
            ],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '5',
            label: '5',
            selectTableCells: ['410 - 412', 'Bildung - Volksschule'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '6',
            label: '6',
            selectTableCells: ['413', 'Mittelschulen - Berufsbildung'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '7',
            label: '7',
            selectTableCells: ['414', 'Fachhochschulen'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '8',
            label: '8',
            selectTableCells: ['415 - 440', 'Universität - Dokumentation - Kultur'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '9',
            label: '9',
            selectTableCells: ['511 - 554', 'Militär - Bevölkerungsschutz - Polizei'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '10',
            label: '10',
            selectTableCells: ['611 - 691', 'Finanzhaushalt - Steuern - Gebühren'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '11',
            label: '11',
            selectTableCells: ['700 - 715', 'Raumplanung - Baurecht - Umweltschutz'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '12',
            ...
            selectTableCells: [
              '720 - 782',
              'Beschaffungswesen - Strassen - Wasserwirtschaft - Energie - Verkehr - Enteignung',
            ],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '13',
            label: '13',
            selectTableCells: ['810 - 857', 'Gesundheit - Arbeit - Sozialversicherung - Fürsorge'],
            id: _.uniqueId('fileNumber'),
          },
          {
            value: '14',
            ...
            selectTableCells: [
              '861 - 954',
              'Feuerpolizei - Landwirtschaft - Wald und Jagd - Industrie und Gewerbe - Handel - Banken',
            ],
            id: _.uniqueId('fileNumber'),
          },
        ],
