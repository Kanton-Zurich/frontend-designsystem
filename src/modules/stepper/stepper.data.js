...
const notification = require('../notification/notification.data').variants;
...
const data = _.merge({}, defaultData, {
  ...
  props: {
    ...
    navigation: {
      steps: [
        'Persönliche Angaben',
        'Berufliche Informationen, mit einem sehr langen Text, Hallo, Hallo, Hallo Hallo',
        'Bestätigung',
      ],
      contextMenu: null,
    },
    ...
    ruleNotification: _.merge({}, notification.closeUserGroup.props, {
      title: 'Wichtig',
      message:
        'Die von Ihnen gemachte Änderung hat gegebenfalls Einfluss auf die danach folgenden Felder. Bitte überprüfen Sie Ihre Angaben erneut.',
      button: null,
    }),
...
const variants = _.mapValues(
  {
    default: {
      ...
      props: {
        remark: false,
        steps: [formVariants.default.props, formVariants.careerInfo.props],
      },
    },
    smaller: {
      meta: {
      ...
      props: {
        steps: [formVariants.phoneOnly.props, formVariants.defaultDuplicate.props],
      },
    },
    withoutNavigation: {
      meta: {
      ...
      props: {
        navigation: false,
        remark:
          '<p>Ihre Daten werden ausschliesslich für den hier ersichtlichen Zweck verwendet.</p><p>Siehe <a class="atm-text_link" href="#">Datenschutzerklärung</a> und <a class="atm-text_link" href="#">Nutzungsbedingungen</a>.</p>',
        steps: [formVariants.defaultDuplicate.props],
      },
    },
    serviceForm: {
      meta: {
      ...
      props: {
        ...
        steps: [_.merge({}, formVariants.defaultDuplicate.props, { sectionTitle: null })],
      },
    },
    withSomeLogic: {
      meta: {
    ...
    withEmptyStepAndlogic: {
      ...
      props: {
        steps: [formVariants.dummyStep2.props, formVariants.withRulesAlt.props],
        navigation: {
    ...
    duplicateUpload: {
      ...
      props: {
        steps: [formVariants.duplicationUpload.props, formVariants.dummyStep1.props],
      },
    },
    nestedRules: {
      meta: {
