  ...
  props: _.merge(
    {
      ...
      teaserText:
        "Beim Kanton Zürich sind über 35'000 Personen angestellt. Sie arbeiten in den unterschiedlichsten Berufen und gestalten den Kanton zum Wohle von Bevölkerung, Unternehmen, Natur sowie Infrastruktur. Werden Sie ein Teil von uns!",
      linkMoreInfo: '#',
      linkAllJobs: '#',
      apiUrl: 'https://live.solique.ch/KTZH/de/api/v1/data/',
      baseUrl: 'https://live.solique.ch/KTZH/de/',
      filters: 'office.id=OFF007;organization.id=ORG10',
      limit: 10,
