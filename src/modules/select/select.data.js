...
const variants = _.mapValues(
  {
    ...
    defaultUpwards: {
      ...
      props: {
        ...
        listData: _.merge(
          {},
          listDemoData.variants.useAnchor.props,
    ...
    singleItem: {
      ...
      props: {
        listData: _.assign(
          ...
          {
            selectOptions: [{ value: 'mig', label: 'Auswahlfeld' }],
          }
        ),
        triggerInputData: inputDemoData.variants.triggerDefault.props,
      },
