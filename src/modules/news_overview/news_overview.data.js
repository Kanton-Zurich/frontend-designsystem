...
const data = _.merge({}, defaultData, {
  ...
  props: {
    ...
    typeSelect: _.assign(
      _.merge({}, selectData.variants.defaultMultiPreSelect.props, {
        listData: {
          validation: {
            isRequired: false,
          },
      ...
      lists: [
        {
          items: [
            _.merge({}, contextMenuItemDef, {
              ...
              iconAfter: false,
              iconBefore: false,
              additionalAttributes: 'data-sort="new"',
              isButton: true,
            }),
            _.merge({}, contextMenuItemDef, {
              text: 'Älteste',
              iconAfter: false,
              iconBefore: false,
              additionalAttributes: 'data-sort="old"',
              isButton: true,
            }),
            _.merge({}, contextMenuItemDef, {
              text: 'Relevanz',
              iconAfter: false,
              iconBefore: false,
              additionalAttributes: 'data-sort="relevance"',
              isButton: true,
            }),
          ],
        },
    ...
    newsTeaserTemplate: templateConverter(
      dataHelper.getFileContent('../news_teaser/_news_teaser_item.hbs'),
      false
    ),
    topNewsTeaserItems: [
      {
