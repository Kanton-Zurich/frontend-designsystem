...
const biometrieHBS = dataHelper.getFileContent(
  '../biometrie_appointment/biometrie_appointment.hbs'
);
...
const data = _.merge({}, defaultData, {
  ...
  props: _.merge(
    { instructions_title: 'Anleitung (H2)' },
    richtextDemoData.props,
    linklistDemoData.props,
    videoDemoData.props,
    { headingLevel: 4 },
    imageFigureDemoData.props,
    carouselDemoData.props,
    { title: { level: 4 } },
      ...
      contentModules: [
        () =>
          handlebars.compile(linklistHBS)(
            _.merge({}, linklistDemoData.props, { headingLevel: 4, isLast: true })
          ),
      ],
    },
    {
      ...
      contentModules: [
        () =>
          handlebars.compile(videoHBS)(
            _.merge({}, videoDemoData.props, { title: true, headingLevel: 4 })
          ),
      ],
    },
    {
      heading: `${headingsPre} (mit Bilder Modul)`,
      contentModules: [() => handlebars.compile(imageFigureHBS)(imageFigureDemoData.props)],
    },
    {
      heading: `${headingsPre} (mit Bildergalerie/Slider Modul)`,
      contentModules: [
        () =>
          handlebars.compile(carouselHBS)(
            _.merge({}, carouselDemoData.props, { title: { level: 4 } })
          ),
      ],
    },
    {
      ...
      contentModules: [
        () =>
          handlebars.compile(texthighlightHBS)(
            _.merge(
              {},
              texthighlightDemoData.props,
    ...
    serviceDemo: {
      ...
      props: {
        ...
        instructionslistItems: [
              ...
              () =>
                handlebars.compile(richtextHBS)({
                  ...
                  contentItems: [
                    {
                      pText:
                        'Klären Sie ab, ob Sie für Ihr Reiseziel einen internationalen Führerschein benötigen. Ihr Reisebüro oder das Konsulat Ihres Reiseziels können Ihnen dabei helfen.',
                    },
                  ],
                }),
              () =>
              ...
              () =>
                handlebars.compile(richtextHBS)({
                  ...
                  contentItems: [
                    ...
                    {
                      pText:
                        'Wenn Ihr Ausweis vor dem 01.01.2013 ausgestellt wurde, müssen Sie ein neues Passfoto machen.',
                    },
                    {
                      pText:
              ...
              () =>
                handlebars.compile(richtextHBS)({
                  ...
                  contentItems: [
                    {
                      pText:
                        'Wenn Ihr Ausweis vor dem 01.01.2013 ausgestellt wurde, müssen Sie ein neues Passfoto machen.  Ihr Reisebüro oder das Konsulat Ihres Reiseziels können Ihnen dabei helfen.',
                    },
                  ],
                }),
          ...
          {
            heading: 'Test',
            contentModules: [() => handlebars.compile(stepperHBS)(defStepperData)],
          },
        ],
      },
    },
