...
const variants = _.mapValues(
  {
    ...
    zhlex_ls: {
      ...
      props: {
        ...
        resultsTemplate: templateConverter(
          '<a href="{{link}}" class="atm-text_link">{{text}}</a>',
          false
        ),
        tableData: {
          tableTitle: '',
              ...
              items: [
                _.merge({}, contextMenuItemDef, {
                  ...
                  additionalAttributes:
                    'data-sort-column="relevance" data-sort-direction="descending"',
                  isButton: true,
                }),
                _.merge({}, contextMenuItemDef, {
                  text: 'Sitzungsdatum aufsteigend',
                  iconAfter: false,
                  iconBefore: false,
                  additionalAttributes:
                    'data-sort-column="sessionDate" data-sort-direction="ascending"',
                  isButton: true,
                }),
                _.merge({}, contextMenuItemDef, {
                  text: 'Sitzungsdatum absteigend',
                  iconAfter: false,
                  iconBefore: false,
                  additionalAttributes:
                    'data-sort-column="sessionDate" data-sort-direction="descending"',
                  isButton: true,
                }),
                _.merge({}, contextMenuItemDef, {
                  text: 'Publikationsdatum aufsteigend',
                  iconAfter: false,
                  iconBefore: false,
                  additionalAttributes:
                    'data-sort-column="publicationDate" data-sort-direction="ascending"',
                  isButton: true,
                }),
                _.merge({}, contextMenuItemDef, {
                  text: 'Publikationsdatum absteigend',
                  iconAfter: false,
                  iconBefore: false,
                  additionalAttributes:
                    'data-sort-column="publicationDate" data-sort-direction="descending"',
                  isButton: true,
                }),
              ],
            },
