...
const pageHeader = require('../page_header/page_header.data');
const footer = require('../footer/footer.data');
const organisationNavigation = require('../organisation_navigation/organisation_navigation.data');
const edirectoryDetails = require('../edirectory_details/edirectory_details.data');
...
const data = _.merge({}, defaultData, {
  ...
  props: {
    ...
    modules: {
      contentModules: [
        () =>
          handlebars.compile(dataHelper.getFileContent('../instructions/instructions.hbs'))(
            defInstructionsData.variants.serviceDemo.props
          ),
      ],
    },
  },
...
const variants = _.mapValues(
  {
    ...
    spa: {
      ...
      props: {
        ...
        fullWidthApp: handlebars.compile(
          dataHelper.getFileContent('../application/application.hbs')
    ...
    iframe: {
      ...
      props: {
        ...
        fullWidthApp: handlebars.compile(dataHelper.getFileContent('../iframe/iframe.hbs'))(
          defIFrameData.variants.fullSize.props
        ),
        modules: {
          servicePageHeaderData: {
            pageTitle: 'IFrame',
    ...
    topicFlyout: {
      ...
      props: {
        ...
        modules: {
          contentModules: [
            () =>
              handlebars.compile(dataHelper.getFileContent('../topiclist/topiclist.hbs'))(
                topiclist.variants.topicsNav.props
              ),
            () =>
              handlebars.compile(
                dataHelper.getFileContent('../organisation_navigation/organisation_navigation.hbs')
              )(organisationNavigation.variants.default.props),
          ],
        },
      },
    },
    ...
    searchFlyout: {
      ...
      props: {
        ...
        modules: {
          contentModules: [
            () =>
              handlebars.compile(dataHelper.getFileContent('../search/search.hbs'))(
                search.variants.default.props
              ),
          ],
        },
    ...
    eDirectory: {
      ...
      props: {
        mainNavigation: false,
        modalId: 'service-modal-edirectory',
        preview: false,
        modules: {
          servicePageHeaderData: pageHeader.variants.eDirectory.props,
          contentModules: [
            () =>
              handlebars.compile(
                dataHelper.getFileContent('../edirectory_details/edirectory_details.hbs')
              )(edirectoryDetails.variants.default.props),
          ],
          servicePageFooterData: footer.variants.eDirectory.props,
        },
      },
    },
  },
