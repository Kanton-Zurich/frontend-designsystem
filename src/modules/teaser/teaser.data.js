  ...
  props: _.merge(
    {
      ...
      teaserDescription:
        'Der Newsletter des Kantons informiert Sie rasch über verabschiedete Geschäfte des Regierungsrates und hält Sie per E-Mail über Neuigkeiten aus der kantonalen Verwaltung auf dem Laufenden. ',
...
const variants = _.mapValues(
  {
    ...
    defaultLeft: {
      ...
      props: {
        ...
        teaserDescription:
          'Die Projekte von Herzog & de Meuron und Christ & Gantebein werten das Hochschulgebiet Zürich Zentrum (HGZZ) auf.',
      },
    },
    inverted: {
      meta: {
    ...
    easyLanguage: {
      meta: {
        ...
        desc: 'Invertierte Hintergrundfarbe. Ohne Datum, ohne Kurztext. Button mit Icon für leichte Sprache.',
      },
      props: {
        hasImage: false,
        inverted: true,
        ...
        teaserDisplayDate: false,
        isEasyLanguage: true,
        headingLevel: 2,
        teaserButtonLabel: 'Zur Übersicht gehen',
        teaserTitle: 'Möchen Sie weitere Inhalte in leichter Sprache lesen?',
      },
    },
    multiple: {
      meta: {
