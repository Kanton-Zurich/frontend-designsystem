  ...
  props: _.merge(
    {
      ...
      h3Text:
        'H3: Black title Kontrollpunkt für mobile Geräte eingerichtet – den ersten in der Schweiz.',
      h4Text: 'H4: Black title',
      pText:
        'P, Regular Interessierte können ab sofort die Genauigkeit ihrer Smartphones und Navigationsgeräte überprüfen. Die' +
      ...
      leadText:
        ...
        ' für mobile Geräte eingerichtet – den ersten in der Schweiz.',
      listItem1:
        'P, Helvetic Roman Interessierte können ab sofort die Genauigkeit ihrer Smartphones und Navigationsgeräte überprüfen.',
      listItem2:
        'Die Baudirektion hat beim Landesmuseum in Zürich einen Kontrollpunkt beim Landesmuseum in Zürich einen Kontrollpunkt.',
      listItem3: 'Koordinaten begegnen uns täglich.',
      benefitItem:
        'Informiert werden, sobald eine Sendung unterwegs ist. Informiert werden, sobald eine Sendung unterwegs ist',
      emphasisText:
        'Das richtige Paradigma von Projektmanagementerfolg stützt sich nicht auf die Einhaltung von Rahmenbedingungen,' +
    ...
    numberHeadings: {
      ...
      props: {
        ...
        customContent: [
          {
            content:
              '<h2 class="atm-heading atm-heading--number-prefix"><span class="atm-heading__prefix">1.</span>Erläuterungen</h2>',
          },
          {
            content:
              '<h3 class="atm-heading atm-heading--number-prefix"><span class="atm-heading__prefix">1.1</span><span class="atm-heading__content">Anrechenbare Vermögenswerte</span></h3>',
          },
          {
            content:
              '<h4 class="atm-heading atm-heading--number-prefix"><span class="atm-heading__prefix">1.1.1</span><span class="atm-heading__content">Bundesebene</span></h4>',
          },
          {
            content:
          ...
          {
            content:
              '<h4 class="atm-heading atm-heading--number-prefix"><span class="atm-heading__prefix">1.2</span><span class="atm-heading__content">Kantonale Verordnungen</span></h4>',
          },
          {
            content:
              '<ul>' +
          ...
          {
            content:
              '<h3 class="atm-heading atm-heading--number-prefix"><span class="atm-heading__prefix">2.</span><span class="atm-heading__content">Persönliche Effekten und Hausrat</span></h3>',
          },
          {
            content:
              '<p class="atm-paragraph">' +
          ...
          {
            content:
              '<h3 class="atm-heading atm-heading--number-prefix"><span class="atm-heading__prefix">3.</span><span class="atm-heading__content">Leistungen aus Genugtuung und Integritätsentschädigungen</span></h3>',
          },
          {
            content:
              '<p class="atm-paragraph">' +
