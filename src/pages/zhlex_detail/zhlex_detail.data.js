...
const defSearchResultDetailHeaderData = require('../../modules/search_result_detail_header/search_result_detail_header.data.js').variants.defaultWithSelect.props;
...
const data = _.merge({}, defaultData, {
  ...
  props: {
    ...
    modules: {
      ...
      searchresultdetailheader: defSearchResultDetailHeaderData,
      metablockData: {
        headingLevel: 2,
