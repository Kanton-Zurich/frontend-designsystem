  ...
  props: {
    ...
    modules: {
      pageHeaderData: {
        ...
        leadSection: {
          leadText:
            'Alle öffentlichen, publizierten Beschlüsse (ab 1. Oktober 2008) können hier nach verschiedenen Kriterien (RRB-Nummer, antragstellende Direktion) oder über die Volltextsuche aufgerufen werden.',
        },
      },
