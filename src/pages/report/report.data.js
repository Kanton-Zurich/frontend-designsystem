...
const pageHeader = require('../../modules/page_header/page_header.data.js').variants.reportsChapter
  .props;
...
const teaserSet = require('../../modules/teaser_set/teaser_set.data.js').variants.reportsOverview
  .props;
...
const data = _.merge({}, defaultData, {
  meta: {
    title: 'Berichtsseite',
    jira: 'CZHDEV-4336',
    content: dataHelper.getFileContent('report.hbs'),
