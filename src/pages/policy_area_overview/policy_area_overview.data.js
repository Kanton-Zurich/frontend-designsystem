...
const skiplinks = require('../../modules/skiplinks/skiplinks.data.js').variants.noToc.props;
const header = require('../../modules/header/header.data').variants.invertedWithUserLoggedOut.props;

const pageHeader = require('../../modules/page_header/page_header.data.js').variants
  .govPlatformPolicyArea.props;
...
const data = _.merge({}, defaultData, {
  meta: {
    title: 'Politikbereich Übersichtsseite',
    jira: 'CZHDEV-3432',
    content: dataHelper.getFileContent('policy_area_overview.hbs'),
