...
const siblingNavigation =
  require('../../modules/sibling_navigation/sibling_navigation.data.js').props;
...
const data = _.merge({}, defaultData, {
  meta: {
    title: 'Langfristiges Ziel Detailseite',
    jira: 'CZHDEV-3444',
    content: dataHelper.getFileContent('longterm_objective_detail.hbs'),
